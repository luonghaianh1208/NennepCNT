    ...
    <div className="space-y-4 pb-24">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="font-bold text-slate-700 mb-3 flex items-center gap-2">
          ...
          Vi phạm theo khối — {thisWeekRange.label} vs {prevWeekRange.label}
        </div>
        <div className="h-44">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={byGradeData} barGap={4} barCategoryGap="30%">
              ...
              <Tooltip
                contentStyle={{ borderRadius: 10, border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)', fontSize: 12 }}
                cursor={{ fill: '#f8fafc' }}
              />
      ...
      {radarData.length >= 3 && (
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          <div className="font-bold text-slate-700 mb-1 flex items-center gap-2">
            ...
            Điểm thi đua các lớp — {thisWeekRange.label}
          </div>
